...
@Composable
private fun OnboardingLabeledField(label: String, value: String, onValueChange: (String) -> Unit) {
...
@Composable
private fun OnboardingPasswordField(label: String, value: String, onValueChange: (String) -> Unit) {
