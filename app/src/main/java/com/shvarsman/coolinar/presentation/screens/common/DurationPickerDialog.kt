            ...
            Column(
                ...
                Row(
                    ...
                    IconButton(onClick = { showDial = !showDial }) {
                        Icon(
                            imageVector = if (showDial) Icons.Filled.Keyboard else Icons.Outlined.Schedule,
                            contentDescription = stringResource(
                                if (showDial) R.string.switch_to_text_input else R.string.switch_to_dial_input
                            )
                        )
                    }
                }
